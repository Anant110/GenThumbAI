...
// This component basically manage the ratios when the users select any particular ratio then manage according to the use
// this component used in Generate.tsx file
